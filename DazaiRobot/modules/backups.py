...
def export_data(update, context):
    ...
    with open("DazaiRobot{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("DazaiRobot{}.backup".format(chat_id), "rb"),
    ...
    os.remove("DazaiRobot{}.backup".format(chat_id))  # Cleaning file
