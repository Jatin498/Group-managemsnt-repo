...
import DazaiRobot.modules.sql.userinfo_sql as sql
...
from DazaiRobot.__main__ import STATS, TOKEN, USER_INFO
...
from DazaiRobot.modules.sql.users_sql import get_user_num_chats
